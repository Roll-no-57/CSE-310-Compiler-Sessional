...
public:
  ...
  virtual void enterStruct_declaration(C8086Parser::Struct_declarationContext *ctx) = 0;
  virtual void exitStruct_declaration(C8086Parser::Struct_declarationContext *ctx) = 0;
  ...
  virtual void enterSwitch_cases(C8086Parser::Switch_casesContext *ctx) = 0;
  virtual void exitSwitch_cases(C8086Parser::Switch_casesContext *ctx) = 0;
