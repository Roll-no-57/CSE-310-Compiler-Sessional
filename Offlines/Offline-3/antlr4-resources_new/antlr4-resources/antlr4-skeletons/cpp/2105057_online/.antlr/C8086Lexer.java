// Generated from /media/apurbo/New Volume/Academy/CSE-310-Compiler-sessional/Offlines/Offline-3/antlr4-resources_new/antlr4-resources/antlr4-skeletons/cpp/2105057_online/C8086Lexer.g4 by ANTLR 4.13.1
...
public class C8086Lexer extends Lexer {
	...
	private void STRUCT_action(RuleContext _localctx, int actionIndex) {
		switch (actionIndex) {
		case 13:
			writeIntoLexLogFile("Line# " + std::to_string(getLine()) + ": Token <STRUCT> Lexeme " + getText());
			break;
		}
	}
