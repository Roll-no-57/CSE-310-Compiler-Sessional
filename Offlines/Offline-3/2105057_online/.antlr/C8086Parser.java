// Generated from /media/apurbo/New Volume/Academy/CSE-310-Compiler-sessional/Offlines/Offline-3/2105057_online/C8086Parser.g4 by ANTLR 4.13.1
	...
	private StatementsContext statements(int _p) throws RecognitionException {
		...
		try {
			...
			((StatementsContext)_localctx).st = statement();
			        ...
			        writeIntoErrorFile("st do "+((StatementsContext)_localctx).st.isDO);
			        if(((StatementsContext)_localctx).st.isDO != "1"){
		...
		try {
			...
			case 11:
				...
				match(SEMICOLON);
				        ...
				        ((StatementContext)_localctx).isDO =  "1";
