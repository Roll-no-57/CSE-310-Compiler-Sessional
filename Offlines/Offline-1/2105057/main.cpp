...
{
    string inputFileName = "corner.txt";
    ...
    // c_str is used to convert string to char* for freopen
    // freopen is used to redirect input and output streams to files
    ...
    SymbolTable *ST = new SymbolTable(numOfBuckets, true);
